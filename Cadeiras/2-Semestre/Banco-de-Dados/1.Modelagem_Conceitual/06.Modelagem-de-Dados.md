...
3. Modelagem Lógica
4. Modelagem Física - Implementação do código
...
A modelagem física é a implementação do modelo lógico no SGBD (sistema de gerenciamento de BD) escolhido, definindo como os dados serão armazenados fisicamente.
